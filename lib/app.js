...
function bandSearch(band) {
    return __awaiter(this, void 0, void 0, function* () {
        var bandlist = yield fetch(questionURL + band, {
            method: 'GET',
            headers: {
    ...
    function (dc, results) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (searchResult.length === 1) {
                ...
                const message = MessageFactory.attachment(CardFactory.heroCard(searchResult[0].bandName, `${searchResult[0].day}, ${searchResult[0].startTime} at the ${searchResult[0].stage} Stage`, [searchResult[0].imageUrl], ['Description', 'Back to Main Menu']));
                ...
                var list = [];
                for (var i = 0; i < l; i++) {
                    list[i] = CardFactory.heroCard(searchResult[i].bandName, `${searchResult[i].day}, ${searchResult[i].startTime} at the ${searchResult[i].stage} Stage`, [searchResult[i].imageUrl], ['Description', 'Back to Main Menu']);
                }
                //caroussel
